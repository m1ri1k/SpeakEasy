...
Исходный код проекта доступен в GitHab. Проект может быть развернут и запущен локально в соответствии с инструкцией в README. Автоматизированные тесты и CI/CD в проекте не используются.
...
**Описание:**  
Исходный код хранится в GitHab \- репозитории проекта SpeakEasy. Проект состоит из backend на Python/FastAPI и frontend в виде статических HTML/CSS/JS-файлов.
